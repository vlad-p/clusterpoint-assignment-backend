...
if (count($params) === 1) {
    ...
    $resourceName = $params[0];
    $resourceId = $params[1];
    $subResourceName = $params[2];
    $subResourceId = $params[3];
} else {
    die('Resource does not exist');
}

echo $resourceName . ' ' . $resourceId . ' ' . $subResourceName . ' ' . $subResourceId;
...
if ($subResourceName === null) {
    ...
    if ($resourceName === 'categories' && $subResourceName === 'adverts') {
